...
public class BigInteger
{
    ...
    static string[] sDisplayPostfix = { "", "K", "M", "B", "t", "q", "Q", "s", "S", "o", "n", "d", "U", "D", "T", "Qt", "Qd", "Sd", "St", "O", "N", "v", "c" };
    //static string[] sDisplayPostfix = { "", "aa", "bb", "cc", "dd", "ee", "ff", "gg", "hh", "ii", "jj", "kk", "ll", "mm", "nn", "oo", "pp", "qq", "rr", "ss", "tt", "uu", "vv", "ww", "xx", "yy", "zz" };


    public string ToString(bool onlyInt = true)
    {
        if (e < 0) return "0";
    ...
    public static BigInteger RoundToInt(BigInteger a)
    {
        if (a >= int.MaxValue) return a;

        return new BigInteger(a.ToInt());
    }
